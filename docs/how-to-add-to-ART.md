...
3. Open `film_scan_converter_directry.sh` and `film_scan_converter_files.sh` for editing
...
6. Launch ART, you should now have additional options for selecing folders and files for conversion

## Video Intructions
A video on how to install and use Film Scan Converter in ART is availalbe [here](https://www.youtube.com/watch?v=8uGc7bAjnsI)
